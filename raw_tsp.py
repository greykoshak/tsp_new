...
if __name__ == "__main__":
    ...
    # Считаем первичную оценку нулевого варианта F0 = mat(0,1) + mat(1,2) + mat(2,3) + mat(3,4) + mat(4,0) =
    # 10 + 10 +20 + 15 + 10 = 65
    ...
    di = np.zeros((n, 1))   # Одномерный массив для выбора минимального значения по строке
    dj = np.zeros((1, n))   # Одномерный массив для выбора минимального значения по столбцу
